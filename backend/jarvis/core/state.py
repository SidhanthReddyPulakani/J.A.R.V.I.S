...
AgentState represents what is currently true about Jarvis.
It is intentionally separate from memory, diary/history, and
...
class AgentState:
    ...
    This represents the agent's current situation, not its
    long-term memory or historical diary.
    """
